...
# %% [markdown]
# ### 1. What parameter(s) most strongly affect twitch duration? Why?

# %% [markdown]
# ### 2. Why does tonic contraction force vary with MTU length?

# %% [markdown]
# ### 3. What changes to your model would reflect age-related muscle slowing?
